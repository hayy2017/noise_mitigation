...
############
# Description: Main script for training the model
# Author: Heike Adel
# Year: 2016
###########
...
from blocks_fuel_classes import MultiInstanceScheme, MultiInstanceSchemeShuffled

from blocks.model import Model
from blocks.algorithms import GradientDescent, Scale, AdaGrad, AdaDelta, Momentum
from blocks.extensions import FinishAfter
from blocks.main_loop import MainLoop
from blocks_fuel_classes import F1MultiClassesExtension, CheckpointAfterEpoch
...
extensions.append(F1MultiClassesExtension(layer3 = layer3, y = y, model = model, data_stream = data_stream_dev, num_samples = len(bag_size_list_dev), batch_size = bag_size_list_dev, name = "dev set", every_n_epochs=1))
extensions.append(F1MultiClassesExtension(layer3 = layer3, y = y, model = model, data_stream = data_stream_test, num_samples = len(bag_size_list_test), batch_size = bag_size_list_test, name = "test set", every_n_epochs=1))
